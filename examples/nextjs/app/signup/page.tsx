...
/**
 * Uncontrolled-forms proof: no value props, no per-keystroke state — the DOM holds the values
 * and FormData reads them on submit. The only state is the submitted result (app land).
 */
